...
const char *ssid =  "Redmi Note 13 Pro 5G";           // replace with your wifi ssid and wpa2 key
const char *pass =  "nztatjx4ek6qf2g";
...
// ==== GET FULL RAW SENTENCE FUNCTION ====
String getSentence()
{
  String ais;
...
void taskTransmitSerial2(void *pvParameters)
{
  while(1)
  {
    Serial2.println(rawAIS);
    delay(100);
...
void setup() {
  ...
  Serial2.begin(38400, SERIAL_8N1, RX2, TX1);
  initTask();
  delay(1000);
  initWifi();
  delay(3000);
